...
Int_t delete::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t delete::LoadTree(Long64_t entry)
{
...
void delete::Show(Long64_t entry)
{
...
Int_t delete::Cut(Long64_t entry)
{
